...
module.exports.run = async (bot, message, args) => {
  if (message.channel.id == "ArchivesChannelID" || message.channel.id == "SomeOtherChaannelID") { message.delete(); message.reply("You can not do it."); }
        else { if (message.member.roles.has("AdministratorRoleID") || message.member.roles.has("ModeratorRoleID")) {
